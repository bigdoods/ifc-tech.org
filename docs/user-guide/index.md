...
* The IFC [User Guide](#user-guide-internal) can help you run programs and services on an existing IFC cluster.
* The [Cluster Admin Guide](/docs/admin/) can help you set up and administrate your own IFC cluster.
* The [Developer Guide](https://github.com/kubernetes/kubernetes/tree/{{page.githubbranch}}/docs/devel) can help you either write code to directly access the IFC API, or to contribute directly to the IFC project.

## <a name="user-guide-internal"></a>Kubernetes User Guide

The following topics in the IFC User Guide can help you run applications and services on a IFC cluster:
...
1. [Application introspection and debugging](/docs/user-guide/introspection-and-debugging/)
    1. [Using the IFC web user interface](/docs/user-guide/ui/)
...
[**Cluster**](/docs/admin/)
: A cluster is a set of physical or virtual machines and other infrastructure resources used by IFC to run your applications.

[**Node**](/docs/admin/node/)
: A node is a physical or virtual machine running IFC, onto which pods can be scheduled.
...
: A volume is a directory, possibly with some data in it, which is accessible to a Container as part of its filesystem.  IFC volumes build upon [Docker Volumes](https://docs.docker.com/engine/tutorials/dockervolumes/), adding provisioning of the volume directory and/or device.
