...
<b>IFC-GUID Base-64 character encoding mapping:</b>
```
0         1         2         3         4         5         6
...
* C sample code based on the Microsoft CoCreateGuid() method written by Peter Muigg and Janos Maros can be downloaded [here](/docs/tutorials/IfcGuid-C-PMuigg.zip).
* Update to C++ by Janos Maros [here](/docs/tutorials/IfcGuid-C-11-JMaros.zip).
* Java sample code written by Jan Tulke and Eike Tauscher can be downloaded [here](/docs/tutorials/IfcGuid-Java.zip)
* Java applet written by Jan Tulke and Eike Tauscher can be downloaded [here](/docs/tutorials/OPENIFCTOOLS_GuidCompressor.zip).
* C# update to previous code by Jeremy Tammik conversion by Hakon Clausen (fixed by Tim Chipman) [here](/docs/tutorials/IfcGuid-CSharp-HClausen.zip). For further reading on the development of this code see this [blog](http://thebuildingcoder.typepad.com/blog/2010/06/ifc-guid-algorithm-in-c.html).