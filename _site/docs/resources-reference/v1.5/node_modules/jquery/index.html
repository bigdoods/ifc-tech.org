...
<title>jQuery | IFC tech site</title>
...
<link rel="canonical" href="http://localhost:4000/docs/resources-reference/v1.5/node_modules/jquery/" />
<meta property="og:url" content="http://localhost:4000/docs/resources-reference/v1.5/node_modules/jquery/" />
<meta property="og:site_name" content="IFC tech site" />
<meta name="twitter:card" content="summary" />
<meta name="twitter:site" content="@buildingSMARTln" />
<script type="application/ld+json">
{"@context":"http://schema.org","@type":"WebPage","headline":"jQuery","description":"Interchanage model for construction industries","publisher":{"@type":"Organization","logo":{"@type":"ImageObject","url":"http://localhost:4000/images/favicon.png"}},"url":"http://localhost:4000/docs/resources-reference/v1.5/node_modules/jquery/"}</script>
<!-- End Jekyll SEO tag -->
...
<section id="encyclopedia">
  ...
  <div id="docsContent">
        <p><a href="/editdocs#docs/resources-reference/v1.5/node_modules/jquery/README.md" id="editPageButton">Edit This Page</a></p>
...
<div class="language-html highlighter-rouge"><pre class="highlight"><code><span class="nt">&lt;script </span><span class="na">src=</span><span class="s">"https://code.jquery.com/jquery-2.2.0.min.js"</span><span class="nt">&gt;&lt;/script&gt;</span>
</code></pre>
</div>
...
<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="kr">import</span> <span class="nx">$</span> <span class="nx">from</span> <span class="s2">"jquery"</span><span class="p">;</span>
</code></pre>
</div>
...
<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">$</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s2">"jquery"</span><span class="p">);</span>
</code></pre>
</div>
...
<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="nx">define</span><span class="p">([</span><span class="s2">"jquery"</span><span class="p">],</span> <span class="kd">function</span><span class="p">(</span><span class="nx">$</span><span class="p">)</span> <span class="p">{</span>
...
<div class="language-sh highlighter-rouge"><pre class="highlight"><code>npm install jquery
</code></pre>
</div>
...
<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="nx">require</span><span class="p">(</span><span class="s2">"jsdom"</span><span class="p">).</span><span class="nx">env</span><span class="p">(</span><span class="s2">""</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nb">window</span><span class="p">)</span> <span class="p">{</span>
...
<span class="p">});</span>
        ...
        <p><a href=""><img src="https://kubernetes-site.appspot.com/UA-36037335-10/GitHub/docs/resources-reference/v1.5/node_modules/jquery/README.md?pixel" alt="Analytics" /></a>
        
		<!-- <script type="text/javascript">
	        PDRTJS_settings_8345992 = {
		        "id" : "8345992",
		        "unique_id" : "/docs/resources-reference/v1.5/node_modules/jquery/",
		        "title" : "jQuery",
		        "permalink" : "http://kubernetes.github.io/docs/resources-reference/v1.5/node_modules/jquery/"
	        };
  ...
  <!-- Need to attach listener to the 'make an issue' button below -->
		...
		<a href="/editdocs#docs/resources-reference/v1.5/node_modules/jquery/README.md" class="button issue">Edit this Page</a>
