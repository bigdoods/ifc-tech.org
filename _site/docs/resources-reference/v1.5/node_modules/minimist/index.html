...
<title>minimist | IFC tech site</title>
...
<link rel="canonical" href="http://localhost:4000/docs/resources-reference/v1.5/node_modules/minimist/" />
<meta property="og:url" content="http://localhost:4000/docs/resources-reference/v1.5/node_modules/minimist/" />
<meta property="og:site_name" content="IFC tech site" />
<meta name="twitter:card" content="summary" />
<meta name="twitter:site" content="@buildingSMARTln" />
<script type="application/ld+json">
{"@context":"http://schema.org","@type":"WebPage","headline":"minimist","description":"Interchanage model for construction industries","publisher":{"@type":"Organization","logo":{"@type":"ImageObject","url":"http://localhost:4000/images/favicon.png"}},"url":"http://localhost:4000/docs/resources-reference/v1.5/node_modules/minimist/"}</script>
<!-- End Jekyll SEO tag -->
...
<section id="encyclopedia">
  ...
  <div id="docsContent">
        <p><a href="/editdocs#docs/resources-reference/v1.5/node_modules/minimist/readme.markdown" id="editPageButton">Edit This Page</a></p>
...
<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">argv</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">'minimist'</span><span class="p">)(</span><span class="nx">process</span><span class="p">.</span><span class="nx">argv</span><span class="p">.</span><span class="nx">slice</span><span class="p">(</span><span class="mi">2</span><span class="p">));</span>
...
<div class="highlighter-rouge"><pre class="highlight"><code>$ node example/parse.js -a beep -b boop
{ _: [], a: 'beep', b: 'boop' }
</code></pre>
</div>

<div class="highlighter-rouge"><pre class="highlight"><code>$ node example/parse.js -x 3 -y 4 -n5 -abc --beep=boop foo bar baz
{ _: [ 'foo', 'bar', 'baz' ],
  x: 3,
  y: 4,
  n: 5,
...
<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">parseArgs</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">'minimist'</span><span class="p">)</span>
</code></pre>
</div>
...
strings</li>
  <li><code class="highlighter-rouge">opts.boolean</code> - a string or array of strings to always treat as booleans</li>
...
<div class="highlighter-rouge"><pre class="highlight"><code>npm install minimist
</code></pre>
</div>
...
<p>MIT</p>
        ...
        <p><a href=""><img src="https://kubernetes-site.appspot.com/UA-36037335-10/GitHub/docs/resources-reference/v1.5/node_modules/minimist/readme.markdown?pixel" alt="Analytics" /></a>
        
		<!-- <script type="text/javascript">
	        PDRTJS_settings_8345992 = {
		        "id" : "8345992",
		        "unique_id" : "/docs/resources-reference/v1.5/node_modules/minimist/",
		        "title" : "minimist",
		        "permalink" : "http://kubernetes.github.io/docs/resources-reference/v1.5/node_modules/minimist/"
	        };
  ...
  <!-- Need to attach listener to the 'make an issue' button below -->
		...
		<a href="/editdocs#docs/resources-reference/v1.5/node_modules/minimist/readme.markdown" class="button issue">Edit this Page</a>
