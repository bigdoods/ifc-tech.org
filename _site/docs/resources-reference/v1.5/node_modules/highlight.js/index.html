...
<title>Highlight.js | IFC tech site</title>
<meta property="og:title" content="Highlight.js" />
...
<link rel="canonical" href="http://localhost:4000/docs/resources-reference/v1.5/node_modules/highlight.js/" />
<meta property="og:url" content="http://localhost:4000/docs/resources-reference/v1.5/node_modules/highlight.js/" />
<meta property="og:site_name" content="IFC tech site" />
<meta name="twitter:card" content="summary" />
<meta name="twitter:site" content="@buildingSMARTln" />
<script type="application/ld+json">
{"@context":"http://schema.org","@type":"WebPage","headline":"Highlight.js","description":"Interchanage model for construction industries","publisher":{"@type":"Organization","logo":{"@type":"ImageObject","url":"http://localhost:4000/images/favicon.png"}},"url":"http://localhost:4000/docs/resources-reference/v1.5/node_modules/highlight.js/"}</script>
<!-- End Jekyll SEO tag -->
...
<section id="encyclopedia">
  ...
  <div id="docsContent">
        <p><a href="/editdocs#docs/resources-reference/v1.5/node_modules/highlight.js/README.md" id="editPageButton">Edit This Page</a></p>
...
<a href="http://highlightjs.readthedocs.io/en/latest/api.html#inithighlightingonload"><code class="highlighter-rouge">initHighlightingOnLoad</code></a>:</p>

<div class="language-html highlighter-rouge"><pre class="highlight"><code><span class="nt">&lt;link</span> <span class="na">rel=</span><span class="s">"stylesheet"</span> <span class="na">href=</span><span class="s">"/path/to/styles/default.css"</span><span class="nt">&gt;</span>
...
<p>This will find and highlight code inside of <code class="highlighter-rouge">&lt;pre&gt;&lt;code&gt;</code> tags; it tries
to detect the language automatically. If automatic detection doesn’t
work for you, you can specify the language in the <code class="highlighter-rouge">class</code> attribute:</p>
...
reference</a>.  Classes can also be prefixed with either <code class="highlighter-rouge">language-</code> or
<code class="highlighter-rouge">lang-</code>.</p>

<p>To disable highlighting altogether use the <code class="highlighter-rouge">nohighlight</code> class:</p>

<div class="language-html highlighter-rouge"><pre class="highlight"><code><span class="nt">&lt;pre&gt;&lt;code</span> <span class="na">class=</span><span class="s">"nohighlight"</span><span class="nt">&gt;</span>...<span class="nt">&lt;/code&gt;&lt;/pre&gt;</span>
</code></pre>
</div>
...
highlight.js, you can use the <a href="http://highlightjs.readthedocs.io/en/latest/api.html#highlightblock-block"><code class="highlighter-rouge">highlightBlock</code></a> and <a href="http://highlightjs.readthedocs.io/en/latest/api.html#configure-options"><code class="highlighter-rouge">configure</code></a>
functions. This allows you to control <em>what</em> to highlight and <em>when</em>.</p>

<p>Here’s an equivalent way to calling <a href="http://highlightjs.readthedocs.io/en/latest/api.html#inithighlightingonload"><code class="highlighter-rouge">initHighlightingOnLoad</code></a> using
jQuery:</p>
...
<p>You can use any tags instead of <code class="highlighter-rouge">&lt;pre&gt;&lt;code&gt;</code> to mark up your code. If
you don’t use a container that preserve line breaks you will need to
configure highlight.js to use the <code class="highlighter-rouge">&lt;br&gt;</code> tag:</p>

<div class="language-javascript highlighter-rouge"><pre class="highlight"><code><span class="nx">hljs</span><span class="p">.</span><span class="nx">configure</span><span class="p">({</span><span class="na">useBR</span><span class="p">:</span> <span class="kc">true</span><span class="p">});</span>
...
<p>For other options refer to the documentation for <a href="http://highlightjs.readthedocs.io/en/latest/api.html#configure-options"><code class="highlighter-rouge">configure</code></a>.</p>
...
<div class="language-javascript highlighter-rouge"><pre class="highlight"><code><span class="nx">addEventListener</span><span class="p">(</span><span class="s1">'load'</span><span class="p">,</span> <span class="kd">function</span><span class="p">()</span> <span class="p">{</span>
  ...
  <span class="kd">var</span> <span class="nx">worker</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">Worker</span><span class="p">(</span><span class="s1">'worker.js'</span><span class="p">);</span>
...
<div class="language-javascript highlighter-rouge"><pre class="highlight"><code><span class="nx">onmessage</span> <span class="o">=</span> <span class="kd">function</span><span class="p">(</span><span class="nx">event</span><span class="p">)</span> <span class="p">{</span>
...
<div class="language-html highlighter-rouge"><pre class="highlight"><code><span class="nt">&lt;script </span><span class="na">src=</span><span class="s">"//cdnjs.cloudflare.com/ajax/libs/highlight.js/9.4.0/languages/go.min.js"</span><span class="nt">&gt;&lt;/script&gt;</span>
</code></pre>
</div>
...
<div class="highlighter-rouge"><pre class="highlight"><code>r.js -o name=hljs paths.hljs=/path/to/highlight out=highlight.js
</code></pre>
</div>
...
<p>Authors and contributors are listed in the <a href="https://github.com/isagalaev/highlight.js/blob/master/AUTHORS.en.txt">AUTHORS.en.txt</a> file.</p>
        ...
        <p><a href=""><img src="https://kubernetes-site.appspot.com/UA-36037335-10/GitHub/docs/resources-reference/v1.5/node_modules/highlight.js/README.md?pixel" alt="Analytics" /></a>
        
		<!-- <script type="text/javascript">
	        PDRTJS_settings_8345992 = {
		        "id" : "8345992",
		        "unique_id" : "/docs/resources-reference/v1.5/node_modules/highlight.js/",
		        "title" : "Highlight.js",
		        "permalink" : "http://kubernetes.github.io/docs/resources-reference/v1.5/node_modules/highlight.js/"
	        };
  ...
  <!-- Need to attach listener to the 'make an issue' button below -->
		...
		<a href="/editdocs#docs/resources-reference/v1.5/node_modules/highlight.js/README.md" class="button issue">Edit this Page</a>
