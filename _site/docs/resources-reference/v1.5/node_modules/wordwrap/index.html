...
<link rel="canonical" href="http://localhost:4000/docs/resources-reference/v1.5/node_modules/wordwrap/" />
<meta property="og:url" content="http://localhost:4000/docs/resources-reference/v1.5/node_modules/wordwrap/" />
<meta property="og:site_name" content="IFC tech site" />
<meta name="twitter:card" content="summary" />
<meta name="twitter:site" content="@buildingSMARTln" />
<script type="application/ld+json">
{"@context":"http://schema.org","@type":"WebPage","headline":"IFC tech site","description":"Interchanage model for construction industries","publisher":{"@type":"Organization","logo":{"@type":"ImageObject","url":"http://localhost:4000/images/favicon.png"}},"url":"http://localhost:4000/docs/resources-reference/v1.5/node_modules/wordwrap/"}</script>
<!-- End Jekyll SEO tag -->
...
<section id="encyclopedia">
  ...
  <div id="docsContent">
        <p><a href="/editdocs#docs/resources-reference/v1.5/node_modules/wordwrap/README.markdown" id="editPageButton">Edit This Page</a></p>
...
<div class="highlighter-rouge"><pre class="highlight"><code>var wrap = require('wordwrap')(15);
...
<div class="highlighter-rouge"><pre class="highlight"><code>You and your
whole family
are made out
of meat.
</code></pre>
...
<div class="highlighter-rouge"><pre class="highlight"><code>var wrap = require('wordwrap')(20, 60);
console.log(wrap(
...
<div class="highlighter-rouge"><pre class="highlight"><code>                    At long last the struggle and tumult
...
<p>Pad out lines with spaces out to column <code class="highlighter-rouge">start</code> and then wrap until column
<code class="highlighter-rouge">stop</code>. If a word is longer than <code class="highlighter-rouge">stop - start</code> characters it will overflow.</p>

<p>In “soft” mode, split chunks by <code class="highlighter-rouge">/(\S+\s+/</code> and don’t break up chunks which are
longer than <code class="highlighter-rouge">stop - start</code>, in “hard” mode, split chunks with <code class="highlighter-rouge">/\b/</code> and break
up chunks longer than <code class="highlighter-rouge">stop - start</code>.</p>

<h2 id="wraphardstart-stop">wrap.hard(start, stop)</h2>

<p>Like <code class="highlighter-rouge">wrap()</code> but with <code class="highlighter-rouge">params.mode = "hard"</code>.</p>


        <p><a href=""><img src="https://kubernetes-site.appspot.com/UA-36037335-10/GitHub/docs/resources-reference/v1.5/node_modules/wordwrap/README.markdown?pixel" alt="Analytics" /></a>
        
		<!-- <script type="text/javascript">
	        PDRTJS_settings_8345992 = {
		        "id" : "8345992",
		        "unique_id" : "/docs/resources-reference/v1.5/node_modules/wordwrap/",
		        "title" : "",
		        "permalink" : "http://kubernetes.github.io/docs/resources-reference/v1.5/node_modules/wordwrap/"
	        };
  ...
  <!-- Need to attach listener to the 'make an issue' button below -->
		...
		<a href="/editdocs#docs/resources-reference/v1.5/node_modules/wordwrap/README.markdown" class="button issue">Edit this Page</a>
